...
const SERVER_EXTERNAL_DOMAIN = 'adstitchdemo.borhan.com';
...
var adPoolUrls = [
	//31 seconds - Blistex
	'http://cdnapi.borhan.com/p/437481/sp/43748100/playManifest/entryId/0_r0rsau9o/flavorId/0_mx13do2t/format/url/protocol/http/a.flv',

	//32 seconds - HomeAway.com
	'http://cdnapi.borhan.com/p/777122/sp/77712200/playManifest/entryId/0_vriq23ct/flavorId/0_g0vnoj5i/format/url/protocol/http/a.mp4',

	//47 seconds - iPhone 4 Gizmodo
	//'http://cdnapi.borhan.com/p/524241/sp/52424100/playManifest/entryId/0_mb7d3bcg/flavorId/0_xwolbf6p/format/url/protocol/http/a.mp4',

	//52 seconds - Google search
	//'http://cdnapi.borhan.com/p/437481/sp/43748100/playManifest/entryId/0_0i5ymzed/flavorId/0_3japm9zh/format/url/protocol/http/a.webm',
];
...
function allocateAdsForUser(res, entryId, uid, adPositions, allocatedAds, adsToPrepare, callback) {
	...
	for (var i = 0; i < adPositions.length; i++) {
		...
		if(ip == '91.142.215.121')
			vastUrl = 'http://search.spotxchange.com/vast/2.0/96156?content_page_url=http://borhantest.com&VPI=MP4&ip_addr=91.142.215.121';
		else
			vastUrl = 'http://search.spotxchange.com/vast/2.0/96157?content_page_url=http://borhantest.com&VPI=MP4&ip_addr=46.20.235.45';
...
function handleHttpRequest(req, res) {
	...
	res.setHeader('X-Borhan-Session', sessionId);
	...
	var protocol = 'http://';
	if (req.headers['x-borhan-f5-https'] == 'ON') {
		protocol = 'https://';
	}
