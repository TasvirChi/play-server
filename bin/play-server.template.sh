...
#
# play-server              This shell script takes care of starting and stopping a Borhan play-server Service
#
# chkconfig: 2345 13 87
# description: Borhan play-server

### BEGIN INIT INFO
# Provides:          borhan-play-server
# Required-Start:    $local_fs $remote_fs $network
# Required-Stop:     $local_fs $remote_fs $network
# Default-Start:     2 3 4 5
# Default-Stop:      0 1 6
# X-Interactive:     true
# Short-Description: Start/stop Borhan play-server
# Description:       Control the Borhan play-server.
### END INIT INFO
