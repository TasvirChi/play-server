...
var BorhanMultiBuffer = function() {
	this.buffers = [];
};

BorhanMultiBuffer.prototype.readFilesInternal = function(fileList, curIndex, callback) {
...
BorhanMultiBuffer.prototype.readFiles = function(fileList, callback) {
	this.readFilesInternal(fileList, 0, callback);
};

BorhanMultiBuffer.prototype.writeFileInternal = function(fd, bufferIndex, callback) {
...
BorhanMultiBuffer.prototype.writeFile = function(outputFile, callback) {
	var This = this;
...
BorhanMultiBuffer.prototype.writeTempFile = function(callback) {
	var This = this;
...
BorhanMultiBuffer.prototype.getPosition = function(position) {
...
BorhanMultiBuffer.prototype.push = function(buffer) {
	this.buffers.push(buffer);
};

BorhanMultiBuffer.prototype.concat = function(multiBuffer) {
	var result = new BorhanMultiBuffer();
	result.buffers = this.buffers.concat(multiBuffer.buffers);
	return result;
};

BorhanMultiBuffer.prototype.slice = function(startPos, endPos) {
	var result = new BorhanMultiBuffer();
...
BorhanMultiBuffer.prototype.reverseWalk = function(endPos, callback) {
...
BorhanMultiBuffer.prototype.toString = function() {
	var result = 'BorhanMultiBuffer {';
	for (var i = 0; i < this.buffers.length; i++) {
		if (i > 0) {
			result += ',';
		}
...
module.exports = BorhanMultiBuffer;
